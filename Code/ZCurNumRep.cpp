...
ZCurNumRep::ZCurNumRep(std::string read , std::vector<std::vector<double>> *rep){
    ...
    for (int i = 0; i < (int)read.size(); i++){
        if(read.substr(i,1) == "A" || read.substr(i,1) == "a"){
            ...
            (*rep)[0][i] = (1.0 + 1.0 + -1.0)/3.0;
            (*rep)[1][i] = (-1.0 + 1.0 + 1.0)/3.0;
            (*rep)[3][i] = (-1.0 + 1.0 + -1.0)/3.0;
        }
            ...
            (*rep)[0][i] = (1.0 + 1.0 + -1.0 + -1.0)/4.0;
            (*rep)[1][i] = (-1.0 + 1.0 + 1.0 + -1.0)/4.0;
            (*rep)[3][i] = (-1.0 + 1.0 + -1.0 + 1.0)/4.0;
        }
    }
};
